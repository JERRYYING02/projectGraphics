class AsteroidSystem {
  ...
  constructor(){
    ...
    this.accelerations = [];
    this.diams = [];
    this.spawnProbability = 0.05; // spawning asteroid probability
    this.timeElapsed = 0;
  ...
  spawn(){
    if (random(1)<this.spawnProbability){
  ...
  increaseDifficulty() {
    // Increase spawning probability
    this.timeElapsed += deltaTime / 1000; // Convert deltaTime to seconds
